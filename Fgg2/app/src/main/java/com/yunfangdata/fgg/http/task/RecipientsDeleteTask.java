 ...
 * 删除收件人
 */
public class RecipientsDeleteTask implements IRequestTask {
     ...
     * @return 结果对象
     */
    public ResultInfo<Boolean> request(String id) {
        ResultInfo<Boolean> result = new ResultInfo<>();
        String url = Constant.HTTP_ALL + Constant.HTTP_RECIPIENTSDELETE;
