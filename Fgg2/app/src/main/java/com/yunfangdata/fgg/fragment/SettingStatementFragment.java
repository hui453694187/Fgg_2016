 ...
 */
public class SettingStatementFragment extends BaseWorkerFragment {

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_setting_statement, container, false);
    ...
    private void loadWebView() {
        ...
        webviewBase.loadUrl("file:///android_asset/Declaration.html");
    ...
    public void changetitel(){
        if (getActivity() instanceof ChangeTitleFromStatement) {
            ((ChangeTitleFromStatement) getActivity()).changeTitleFromStatement();
        }
    }
     ...
     * 改变标题文字的接口
     */
    public interface ChangeTitleFromStatement{
        /**
         * 改变标题文字的接口
         */
        void changeTitleFromStatement();
    }
}