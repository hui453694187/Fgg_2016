 ...
 * 修改收件人
 */
public class RecipientsUpdateTask implements IRequestTask {
    /**
     * 返回数据
     */
    private byte[] mData;
    ...
    public ResultInfo<Boolean> request(String userName,PersonRecipients personRecipients) {
        ResultInfo<Boolean> result = new ResultInfo<>();
        String url = Constant.HTTP_ALL + Constant.HTTP_RECIPIENTSUPDATE;
        // 填充参数，key-value。key是接口要求传的变量名称
        Hashtable<String, Object> params = new Hashtable<>(8);
        params.put("addressId", personRecipients.getYouJiDiZhiId());
